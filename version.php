...
return [
    ...
    '4.0.0' => [
        ...
        'test(arch): add ArchTest.php and enhance Pest.php with custom expectations and helpers',
        'refactor: apply rector',
        'ci(config): Update config files',
        'style: apply php-cs-fixer',
        'ci(composer): Update composer.json for improved dependencies and scripts',
        'feat(requirements): Update minimum PHP version to 8.2',
        ...
        'Merge pull request #67 from guanguans/dependabot/github_actions/dependabot/fetch-metadata-2.5.0',
        'chore(deps): bump dependabot/fetch-metadata from 2.4.0 to 2.5.0',
        'Merge pull request #66 from guanguans/dependabot/github_actions/actions/cache-5',
        'chore(deps): bump actions/cache from 4 to 5',
        'Merge pull request #65 from guanguans/dependabot/github_actions/actions/checkout-6',
        'chore(deps): bump actions/checkout from 5 to 6',
        'Merge pull request #64 from guanguans/dependabot/github_actions/actions/setup-node-6',
        'chore(deps): bump actions/setup-node from 5 to 6',
        'Merge pull request #63 from guanguans/dependabot/github_actions/stefanzweifel/git-auto-commit-action-7',
        'chore(deps): bump stefanzweifel/git-auto-commit-action from 6 to 7',
        'Merge pull request #62 from guanguans/dependabot/github_actions/actions/labeler-6',
        'Merge pull request #61 from guanguans/dependabot/github_actions/actions/stale-10',
        'Merge pull request #60 from guanguans/dependabot/github_actions/actions/setup-node-5',
        'chore(deps): bump actions/labeler from 5 to 6',
        'chore(deps): bump actions/stale from 9 to 10',
        'chore(deps): bump actions/setup-node from 4 to 5',
        'Merge pull request #59 from guanguans/dependabot/github_actions/actions/checkout-5',
        'chore(deps): bump actions/checkout from 4 to 5',
        'Merge pull request #58 from guanguans/dependabot/github_actions/stefanzweifel/git-auto-commit-action-6',
        'chore(deps): bump stefanzweifel/git-auto-commit-action from 5 to 6',
        'Merge pull request #57 from guanguans/dependabot/github_actions/dependabot/fetch-metadata-2.4.0',
    ...
    '4.1.0' => [
        'feat(deps): update gregwar/captcha to version 2.1',
        'Merge pull request #85 from guanguans/dependabot/github_actions/github/codeql-action-4.38.0',
        'chore(deps): bump github/codeql-action from 4.37.9 to 4.38.0',
        'Merge pull request #84 from guanguans/dependabot/github_actions/github/codeql-action-4.37.9',
        'chore(deps): bump github/codeql-action from 4.37.8 to 4.37.9',
        'Merge pull request #83 from guanguans/dependabot/github_actions/github/codeql-action-4.37.8',
        'chore(deps): bump github/codeql-action from 4.37.7 to 4.37.8',
        'Merge pull request #82 from guanguans/dependabot/github_actions/github/codeql-action-4.37.7',
        'chore(deps): bump github/codeql-action from 4.37.6 to 4.37.7',
        'Merge pull request #81 from guanguans/dependabot/github_actions/github/codeql-action-4.37.6',
        'chore(deps): bump github/codeql-action from 4.37.5 to 4.37.6',
        'chore(deps): bump github/codeql-action from 4.37.4 to 4.37.5',
        'Merge pull request #79 from guanguans/dependabot/github_actions/github/codeql-action-4.37.4',
        'chore(deps): bump github/codeql-action from 4.37.3 to 4.37.4',
        'Merge pull request #78 from guanguans/dependabot/github_actions/github/codeql-action-4.37.3',
        ...
        'chore(deps): update gregwar/captcha requirement || ^2.0',
        'chore(deps): bump codecov/codecov-action from 6 to 7',
        'chore(deps-dev): update rector/jack requirement || ^1.0',
        'Merge pull request #70 from guanguans/dependabot/github_actions/dependabot/fetch-metadata-3.1.0',
